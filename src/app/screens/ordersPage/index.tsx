          ...
          <TabContext value={value}>
            <Box className="order-nav-frame">
              <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                ...
                >
                  <Tab className='color-button' label="PAUSED ORDERS" value="1" />
                  <Tab className='color-button' label="PROCESS ORDERS" value="2" />
                  <Tab className='color-button' label="FINISHED ORDERS" value="3" />
                </Tabs>
              </Box>
            </Box>
